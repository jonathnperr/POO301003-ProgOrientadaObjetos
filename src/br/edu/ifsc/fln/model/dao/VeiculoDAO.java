...
public class VeiculoDAO {
    ...
    public void inserir(Veiculo veiculo){
        String sql = "INSERT INTO veiculo(placa, observacao, id_cor, id_modelo) VALUES(?,?,?,?)";
        try {
    ...
    public void alterar(Veiculo veiculo){
        String sql = "UPDATE veiculo SET placa=?, observacao=?, id_cor=?, id_modelo=? WHERE id=?";
        try {
            PreparedStatement stmt = connection.prepareStatement(sql);
            stmt.setString(1, veiculo.getPlaca());
            stmt.setString(2, veiculo.getObservacoes());
    ...
    public List<Veiculo> listar(){
        String sql =  "SELECT v.id as id_veiculo, v.placa as veiculo_placa, v.observacao as veiculo_observacao, "
                ...
                + "c.id as id_cor, c.nome as cor_nome "
                + "FROM veiculo v "
    ...
    private Veiculo populateVO(ResultSet rs) throws SQLException{
        ...
        veiculo.setObservacoes(rs.getString("veiculo_observacao"));
